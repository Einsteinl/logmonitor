...
public class MailCenterConstant {
    ...
    public final static String FROM_ADDRESS = "15222871082@163.com";
    public final static String USER = "15222871082@163.com";
    public final static String PWD = "lei.01820088";
}
